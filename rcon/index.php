...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="/rcon/static/css/bootstrap.min.css" />
  <link rel="stylesheet" type="text/css" href="/rcon/static/css/style.css">
  <script type="text/javascript" src="/rcon/static/js/jquery-1.12.0.min.js"></script>
  <script type="text/javascript" src="/rcon/static/js/jquery-migrate-1.2.1.min.js"></script>
  <script type="text/javascript" src="/rcon/static/js/jquery-ui-1.12.0.min.js"></script>
  <script type="text/javascript" src="/rcon/static/js/bootstrap.min.js"></script>
...
<body>
  <div class="container-fluid" id="content">
    <div class="alert alert-info" id="alertMessage">
      Сервер: <?=$data['name'] ?> <?=$data['version'] ?> (<?=$data['host'] ?>:<?=$data['port'] ?>)
    </div>
    <div id="consoleRow">
      <div class="panel panel-default" id="consoleContent">
        <div class="panel-heading">
          ...
          <div class="btn-group btn-group-xs pull-right">
            <a class="btn btn-default" href="http://minecraft.gamepedia.com/Commands" target="_blank"><span class="glyphicon glyphicon-question-sign"></span><span class="hidden-xs"> Команды</span></a>
            <a class="btn btn-default" href="http://www.minecraftinfo.com/idlist.htm" target="_blank"><span class="glyphicon glyphicon-info-sign"></span><span class="hidden-xs"> ID предметов</span></a>
          </div>
        </div>
      ...
      <div class="input-group" id="consoleCommand">
        ...
        <div class="input-group-btn">
          <button type="button" class="btn btn-primary" id="btnSend"><span class="glyphicon glyphicon-send"></span><span class="hidden-xs"> Отправить</span></button>
          <button type="button" class="btn btn-warning" id="btnClearLog"><span class="glyphicon glyphicon-erase"></span><span class="hidden-xs"> Очистить</span></button>
        </div>
      </div>
    </div>
  </div>
  <script>
    $(document).ready(function() {
      ...
      var autocompleteCommands = [
        ...
        "locate Temple",
        "locate Village",
        "lp creategroup <название>",
        "lp deletegroup <название>",
        "lp group <группа> setdisplayname <имя>",
        "lp editor groups",
        "lp group <группа> parent add <группа-1>",
        "lp group <группа> parent remove <группа-1>",
        "lp user <игрок> parent add <группа>",
        "lp user <игрок> parent remove <группа>",
        "lp user <игрок> parent set <группа>",
        "lp group <группа> addprefix <вес> <значение>",
        "lp group <группа> addsuffix <вес> <значение>",
        "lp group <группа> removeprefix <вес> [значение]",
        "lp group <группа> removesuffix <вес> [значение]",
        "lp export <файл>",
        "lp import <файл>",
        "",
        "",
      ...
      $.post("/admin/rcon/<?=$id?>", {
        ...
        .done(function(json) {
          if (json.status) {
            ...
            alertDanger("RCON api error (Не возвращает статус)");
            logDanger("RCON api error (Не возвращает статус)");
          }
        })
        .fail(function() {
